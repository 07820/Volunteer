...
namespace Activity
{
    public partial class ClosedStuDetail : Form
    {
        private Topic topic;
        public ClosedStuDetail(Topic topic)
        {
            InitializeComponent();
            ...
            // 订阅 Load 和 Resize 事件
            this.Load += ClosedStuDetail_Load;
            this.Resize += ClosedStuDetail_Resize;
        }

        private void ClosedStuDetail_Load(object sender, EventArgs e)
        {
            lb1.Text = topic.StuName;
        ...
        private void ClosedStuDetail_Resize(object sender, EventArgs e)
        {
            panel2.Location = new Point((this.ClientSize.Width - panel2.Width )/ 2, (this.ClientSize.Height - panel2.Height) / 2);
